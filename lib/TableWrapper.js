...
var TableWrapper = /** @class */ (function (_super) {
    ...
    TableWrapper.prototype.selectedRowChange = function (selectedRowKeys, selectedRows) {
        this.setState({
    ...
    TableWrapper.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement(Actions_1.default, { actions: actions, selectedRowKeys: selectedRowKeys, selectedRows: selectedRows, selectedRowChange: this.selectedRowChange, position: position }),
            React.createElement(LBTable_1.default, __assign({}, props, { selectedRowKeys: selectedRowKeys, selectedRowChange: this.selectedRowChange }))));
    };
    return TableWrapper;
}(React.Component));
