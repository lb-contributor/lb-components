...
var Fields = function (_Component) {
  ...
  _createClass(Fields, [{
    ...
    value: function renderButtons() {
      ...
      var buttons = _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _button2.default,
            { type: 'primary', htmlType: 'submit', onClick: this.query, loading: this.state.loading },
            '\u67E5\u8BE2'
          ),
          _react2.default.createElement(
            _button2.default,
    ...
    value: function renderFormItems() {
      ...
      var fields = this.state.collapsed ? this.props.fields[0] : [].concat(_toConsumableArray(this.props.fields[0]), _toConsumableArray(this.props.fields[1]));
    ...
    value: function renderFormItemSelect(field) {
      var select = _react2.default.createElement(_select2.default, { allowClear: !field.required, dropdownMatchSelectWidth: false, style: { width: '100%' }, options: field.options });
