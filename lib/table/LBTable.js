...
var LBTable = /** @class */ (function (_super) {
    ...
    LBTable.prototype.render = function () {
        var _a = this.props, columns = _a.columns, data = _a.data, rowSelection = _a.rowSelection, selectedRowKeys2 = _a.selectedRowKeys2, props = __rest(_a, ["columns", "data", "rowSelection", "selectedRowKeys2"]);
        return (React.createElement(table_1.default, __assign({ bordered: true, size: "small", rowSelection: this.rowSelection ? Object.assign({}, this.rowSelection, { selectedRowKeys: selectedRowKeys2 }) : this.rowSelection, columns: columns, dataSource: data }, props)));
    };
    LBTable.propTypes = {
