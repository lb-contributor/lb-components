...
var LBTable = function (_Component) {
  ...
  _createClass(LBTable, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      return this.props.data !== nextProps.data || this.props.selectedRowKeys !== nextProps.selectedRowKeys;
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(_table2.default, _extends({
        bordered: true,
        size: 'small',
        rowSelection: Object.assign({}, this.rowSelection, { selectedRowKeys: selectedRowKeys }),
        columns: columns,
        dataSource: data
      }, props));
    }
